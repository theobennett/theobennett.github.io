...
;(function () {
  ...
  var PageTransition = {
   ...
   /* ══════════════════════════════════════════════════════════
     16b. VIDEO HERO
     Play/pause based on visibility, poster fallback if
     video fails, performance-conscious behavior.
     ══════════════════════════════════════════════════════════ */
  ...
  /* ══════════════════════════════════════════════════════════
     16c. AMBIENT VIDEOS
     Any autoplaying loop video outside the hero (e.g. gallery
     tiles) is paused when it scrolls out of view to save
     battery and GPU. Purely progressive enhancement.
     ══════════════════════════════════════════════════════════ */
  ...
  var AmbientVideos = {
    init: function () {
      ...
      var videos = $$('video[autoplay]').filter(function (v) {
        return !v.classList.contains('hero__video')
      })
